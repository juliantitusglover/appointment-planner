...
function App() {
  ...
  */
  const addContact = (name, phoneNumber, email) => {
    setContacts((prevContacts) => [...prevContacts, {"name": name, "phoneNumber": phoneNumber, "email": email}]);
  }

  const addAppointment = (name, contact, date, time) => {
    setAppointments((prevAppointments) => [...prevAppointments, {"name": name, "contact": contact, "date": date, "time": time}]);
  }
